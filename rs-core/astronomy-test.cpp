...
void test_core_astronomy_coordinate_systems() {
    ...
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dms2,˚,\',\""));  TEST_EQUAL(text, "1˚23\'45.67\"");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dms2s"));         TEST_EQUAL(text, "1˚23\'45.67\"");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dms2is"));        TEST_EQUAL(text, "1˚23\'45\".67");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dms2ips"));       TEST_EQUAL(text, "001˚23\'45\".67");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dm2s"));          TEST_EQUAL(text, "1˚23.76\'");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dm2ips"));        TEST_EQUAL(text, "001˚23\'.76");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "d2s"));           TEST_EQUAL(text, "1.40˚");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "d2ips"));         TEST_EQUAL(text, "001˚.40");
    ...
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dms+2s"));        TEST_EQUAL(text, "+1˚23\'45.67\"");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dms+2is"));       TEST_EQUAL(text, "+1˚23\'45\".67");
    TRY(rad = degrees_to_radians(1, 23, 45.67));    TRY(text = format_angle(rad, "dms+2ips"));      TEST_EQUAL(text, "+001˚23\'45\".67");
    TRY(rad = - degrees_to_radians(1, 23, 45.67));  TRY(text = format_angle(rad, "dms2"));          TEST_EQUAL(text, "-1 23 45.67");
    TRY(rad = - degrees_to_radians(1, 23, 45.67));  TRY(text = format_angle(rad, "dms2s"));         TEST_EQUAL(text, "-1˚23\'45.67\"");
    TRY(rad = - degrees_to_radians(1, 23, 45.67));  TRY(text = format_angle(rad, "dms2is"));        TEST_EQUAL(text, "-1˚23\'45\".67");
    TRY(rad = - degrees_to_radians(1, 23, 45.67));  TRY(text = format_angle(rad, "dms2ips"));       TEST_EQUAL(text, "-001˚23\'45\".67");
