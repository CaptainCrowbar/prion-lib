...
void test_core_common_integer_arithmetic() {
    ...
    TEST_EQUAL(int_power(10ll, 0), 1ll);
    TEST_EQUAL(int_power(10ll, 1), 10ll);
    TEST_EQUAL(int_power(10ll, 2), 100ll);
    TEST_EQUAL(int_power(10ll, 3), 1000ll);
    TEST_EQUAL(int_power(10ll, 4), 10000ll);
    TEST_EQUAL(int_power(10ll, 5), 100000ll);
    TEST_EQUAL(int_power(10ll, 6), 1000000ll);
    TEST_EQUAL(int_power(10ll, 7), 10000000ll);
    TEST_EQUAL(int_power(10ll, 8), 100000000ll);
    TEST_EQUAL(int_power(10ll, 9), 1000000000ll);
    TEST_EQUAL(int_power(10ll, 10), 10000000000ll);
    ...
    TEST_EQUAL(int_power(10ull, 0), 1ull);
    TEST_EQUAL(int_power(10ull, 1), 10ull);
    TEST_EQUAL(int_power(10ull, 2), 100ull);
    TEST_EQUAL(int_power(10ull, 3), 1000ull);
    TEST_EQUAL(int_power(10ull, 4), 10000ull);
    TEST_EQUAL(int_power(10ull, 5), 100000ull);
    TEST_EQUAL(int_power(10ull, 6), 1000000ull);
    TEST_EQUAL(int_power(10ull, 7), 10000000ull);
    TEST_EQUAL(int_power(10ull, 8), 100000000ull);
    TEST_EQUAL(int_power(10ull, 9), 1000000000ull);
    TEST_EQUAL(int_power(10ull, 10), 10000000000ull);
