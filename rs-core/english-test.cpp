...
namespace {
    ...
    RS_ENUM_CLASS(Thing, int, 1, alpha_one, bravo_two, charlie_three);
...
void test_core_english_case_conversion() {
    ...
    TEST_EQUAL(format_enum(Thing::charlie_three), "charlie three");
    TEST_EQUAL(format_enum(Thing::alpha_one, "t"), "Alpha One");
    TEST_EQUAL(format_enum(Thing::bravo_two, "t"), "Bravo Two");
    TEST_EQUAL(format_enum(Thing::charlie_three, "t"), "Charlie Three");
    TEST_EQUAL(format_enum(Thing::alpha_one, "t-"), "Alpha-One");
    TEST_EQUAL(format_enum(Thing::bravo_two, "t-"), "Bravo-Two");
    TEST_EQUAL(format_enum(Thing::charlie_three, "t-"), "Charlie-Three");
...
void test_core_english_list_formatting() {
    ...
    list = {"alpha"};                               TEST_EQUAL(comma_list(list), "alpha");                         TEST_EQUAL(comma_list(list, "and"), "alpha");
    list = {"alpha", "bravo"};                      TEST_EQUAL(comma_list(list), "alpha, bravo");                  TEST_EQUAL(comma_list(list, "and"), "alpha and bravo");
    list = {"alpha", "bravo", "charlie"};           TEST_EQUAL(comma_list(list), "alpha, bravo, charlie");         TEST_EQUAL(comma_list(list, "and"), "alpha, bravo, and charlie");
    list = {"alpha", "bravo", "charlie", "delta"};  TEST_EQUAL(comma_list(list), "alpha, bravo, charlie, delta");  TEST_EQUAL(comma_list(list, "and"), "alpha, bravo, charlie, and delta");
