...
void test_core_mp_integer_unsigned_conversion() {
    ...
    TRY(x = Mpuint("1", 2));                                     TRY(s = x.str());  TEST_EQUAL(s, "1");
    TRY(x = Mpuint("12", 3));                                    TRY(s = x.str());  TEST_EQUAL(s, "5");
    TRY(x = Mpuint("123", 4));                                   TRY(s = x.str());  TEST_EQUAL(s, "27");
    TRY(x = Mpuint("1234", 5));                                  TRY(s = x.str());  TEST_EQUAL(s, "194");
    TRY(x = Mpuint("12345", 6));                                 TRY(s = x.str());  TEST_EQUAL(s, "1865");
    TRY(x = Mpuint("123456", 7));                                TRY(s = x.str());  TEST_EQUAL(s, "22875");
    TRY(x = Mpuint("1234567", 8));                               TRY(s = x.str());  TEST_EQUAL(s, "342391");
    TRY(x = Mpuint("12345678", 9));                              TRY(s = x.str());  TEST_EQUAL(s, "6053444");
    TRY(x = Mpuint("123456789", 10));                            TRY(s = x.str());  TEST_EQUAL(s, "123456789");
    TRY(x = Mpuint("123456789a", 11));                           TRY(s = x.str());  TEST_EQUAL(s, "2853116705");
    TRY(x = Mpuint("123456789ab", 12));                          TRY(s = x.str());  TEST_EQUAL(s, "73686780563");
    TRY(x = Mpuint("123456789abc", 13));                         TRY(s = x.str());  TEST_EQUAL(s, "2103299351334");
    TRY(x = Mpuint("123456789abcd", 14));                        TRY(s = x.str());  TEST_EQUAL(s, "65751519677857");
    TRY(x = Mpuint("123456789abcde", 15));                       TRY(s = x.str());  TEST_EQUAL(s, "2234152501943159");
    TRY(x = Mpuint("123456789abcdef", 16));                      TRY(s = x.str());  TEST_EQUAL(s, "81985529216486895");
    TRY(x = Mpuint("123456789abcdefg", 17));                     TRY(s = x.str());  TEST_EQUAL(s, "3231407272993502984");
    TRY(x = Mpuint("123456789abcdefgh", 18));                    TRY(s = x.str());  TEST_EQUAL(s, "136146740744970718253");
    TRY(x = Mpuint("123456789abcdefghi", 19));                   TRY(s = x.str());  TEST_EQUAL(s, "6106233505124424657789");
    TRY(x = Mpuint("123456789abcdefghij", 20));                  TRY(s = x.str());  TEST_EQUAL(s, "290464265927977839335179");
    TRY(x = Mpuint("123456789abcdefghijk", 21));                 TRY(s = x.str());  TEST_EQUAL(s, "14606467545964956303452810");
    TRY(x = Mpuint("123456789abcdefghijkl", 22));                TRY(s = x.str());  TEST_EQUAL(s, "774212873841767703847271481");
    TRY(x = Mpuint("123456789abcdefghijklm", 23));               TRY(s = x.str());  TEST_EQUAL(s, "43141462809603124037923621715");
    TRY(x = Mpuint("123456789abcdefghijklmn", 24));              TRY(s = x.str());  TEST_EQUAL(s, "2521239653781255433741174806887");
    TRY(x = Mpuint("123456789abcdefghijklmno", 25));             TRY(s = x.str());  TEST_EQUAL(s, "154197642309049519503282176123724");
    TRY(x = Mpuint("123456789abcdefghijklmnop", 26));            TRY(s = x.str());  TEST_EQUAL(s, "9849791328331451697274678861440325");
    TRY(x = Mpuint("123456789abcdefghijklmnopq", 27));           TRY(s = x.str());  TEST_EQUAL(s, "655956343554789600515162175472115225");
    TRY(x = Mpuint("123456789abcdefghijklmnopqr", 28));          TRY(s = x.str());  TEST_EQUAL(s, "45467109894723422308055868660308101251");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrs", 29));         TRY(s = x.str());  TEST_EQUAL(s, "3275109889236238692043148233075275671534");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrst", 30));        TRY(s = x.str());  TEST_EQUAL(s, "244817041729665873959571938168846611177169");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrstu", 31));       TRY(s = x.str());  TEST_EQUAL(s, "18965749034136928842900714476732571951160815");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrstuv", 32));      TRY(s = x.str());  TEST_EQUAL(s, "1520813358304789717173449357665226867487963103");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrstuvw", 33));     TRY(s = x.str());  TEST_EQUAL(s, "126084023523204128749625029233070835487633968144");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrstuvwx", 34));    TRY(s = x.str());  TEST_EQUAL(s, "10795811667005157035274610194040730536839248769117");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrstuvwxy", 35));   TRY(s = x.str());  TEST_EQUAL(s, "953726210513969460165905219215837671424690827366389");
    TRY(x = Mpuint("123456789abcdefghijklmnopqrstuvwxyz", 36));  TRY(s = x.str());  TEST_EQUAL(s, "86846823611197163108337531226495015298096208677436155");
...
void test_core_mp_integer_signed_conversion() {
    ...
    TRY(x = Mpint("+1", 2));                                     TRY(s = x.str());  TEST_EQUAL(s, "1");
    TRY(x = Mpint("-12", 3));                                    TRY(s = x.str());  TEST_EQUAL(s, "-5");
    TRY(x = Mpint("+123", 4));                                   TRY(s = x.str());  TEST_EQUAL(s, "27");
    TRY(x = Mpint("-1234", 5));                                  TRY(s = x.str());  TEST_EQUAL(s, "-194");
    TRY(x = Mpint("+12345", 6));                                 TRY(s = x.str());  TEST_EQUAL(s, "1865");
    TRY(x = Mpint("-123456", 7));                                TRY(s = x.str());  TEST_EQUAL(s, "-22875");
    TRY(x = Mpint("+1234567", 8));                               TRY(s = x.str());  TEST_EQUAL(s, "342391");
    TRY(x = Mpint("-12345678", 9));                              TRY(s = x.str());  TEST_EQUAL(s, "-6053444");
    TRY(x = Mpint("+123456789", 10));                            TRY(s = x.str());  TEST_EQUAL(s, "123456789");
    TRY(x = Mpint("-123456789a", 11));                           TRY(s = x.str());  TEST_EQUAL(s, "-2853116705");
    TRY(x = Mpint("+123456789ab", 12));                          TRY(s = x.str());  TEST_EQUAL(s, "73686780563");
    TRY(x = Mpint("-123456789abc", 13));                         TRY(s = x.str());  TEST_EQUAL(s, "-2103299351334");
    TRY(x = Mpint("+123456789abcd", 14));                        TRY(s = x.str());  TEST_EQUAL(s, "65751519677857");
    TRY(x = Mpint("-123456789abcde", 15));                       TRY(s = x.str());  TEST_EQUAL(s, "-2234152501943159");
    TRY(x = Mpint("+123456789abcdef", 16));                      TRY(s = x.str());  TEST_EQUAL(s, "81985529216486895");
    TRY(x = Mpint("-123456789abcdefg", 17));                     TRY(s = x.str());  TEST_EQUAL(s, "-3231407272993502984");
    TRY(x = Mpint("+123456789abcdefgh", 18));                    TRY(s = x.str());  TEST_EQUAL(s, "136146740744970718253");
    TRY(x = Mpint("-123456789abcdefghi", 19));                   TRY(s = x.str());  TEST_EQUAL(s, "-6106233505124424657789");
    TRY(x = Mpint("+123456789abcdefghij", 20));                  TRY(s = x.str());  TEST_EQUAL(s, "290464265927977839335179");
    TRY(x = Mpint("-123456789abcdefghijk", 21));                 TRY(s = x.str());  TEST_EQUAL(s, "-14606467545964956303452810");
    TRY(x = Mpint("+123456789abcdefghijkl", 22));                TRY(s = x.str());  TEST_EQUAL(s, "774212873841767703847271481");
    TRY(x = Mpint("-123456789abcdefghijklm", 23));               TRY(s = x.str());  TEST_EQUAL(s, "-43141462809603124037923621715");
    TRY(x = Mpint("+123456789abcdefghijklmn", 24));              TRY(s = x.str());  TEST_EQUAL(s, "2521239653781255433741174806887");
    TRY(x = Mpint("-123456789abcdefghijklmno", 25));             TRY(s = x.str());  TEST_EQUAL(s, "-154197642309049519503282176123724");
    TRY(x = Mpint("+123456789abcdefghijklmnop", 26));            TRY(s = x.str());  TEST_EQUAL(s, "9849791328331451697274678861440325");
    TRY(x = Mpint("-123456789abcdefghijklmnopq", 27));           TRY(s = x.str());  TEST_EQUAL(s, "-655956343554789600515162175472115225");
    TRY(x = Mpint("+123456789abcdefghijklmnopqr", 28));          TRY(s = x.str());  TEST_EQUAL(s, "45467109894723422308055868660308101251");
    TRY(x = Mpint("-123456789abcdefghijklmnopqrs", 29));         TRY(s = x.str());  TEST_EQUAL(s, "-3275109889236238692043148233075275671534");
    TRY(x = Mpint("+123456789abcdefghijklmnopqrst", 30));        TRY(s = x.str());  TEST_EQUAL(s, "244817041729665873959571938168846611177169");
    TRY(x = Mpint("-123456789abcdefghijklmnopqrstu", 31));       TRY(s = x.str());  TEST_EQUAL(s, "-18965749034136928842900714476732571951160815");
    TRY(x = Mpint("+123456789abcdefghijklmnopqrstuv", 32));      TRY(s = x.str());  TEST_EQUAL(s, "1520813358304789717173449357665226867487963103");
    TRY(x = Mpint("-123456789abcdefghijklmnopqrstuvw", 33));     TRY(s = x.str());  TEST_EQUAL(s, "-126084023523204128749625029233070835487633968144");
    TRY(x = Mpint("+123456789abcdefghijklmnopqrstuvwx", 34));    TRY(s = x.str());  TEST_EQUAL(s, "10795811667005157035274610194040730536839248769117");
    TRY(x = Mpint("-123456789abcdefghijklmnopqrstuvwxy", 35));   TRY(s = x.str());  TEST_EQUAL(s, "-953726210513969460165905219215837671424690827366389");
    TRY(x = Mpint("+123456789abcdefghijklmnopqrstuvwxyz", 36));  TRY(s = x.str());  TEST_EQUAL(s, "86846823611197163108337531226495015298096208677436155");
